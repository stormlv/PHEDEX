package PHEDEX::Tests::Helpers::SessionCreation;
...
sub setupResourceManager {
    ...
    $backend = 'Other::Dummy' if ! defined $backend;
    ...
    my $circuitManager = PHEDEX::File::Download::Circuits::ResourceManager::ResourceManager->new(BACKEND_TYPE => $backend,
