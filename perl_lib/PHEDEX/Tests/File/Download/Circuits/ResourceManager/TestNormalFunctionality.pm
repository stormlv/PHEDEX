package PHEDEX::Tests::File::Download::Circuits::ResourceManager::TestNormalFunctionality;
...
use PHEDEX::Tests::Helpers::SessionCreation;


# Tests the various smaller subroutines (checkCircuit, canRequestCircuit) from the circuit manager
sub testHelperMethods {
    my $circuitManager = PHEDEX::File::Download::Circuits::ResourceManager::ResourceManager->new(BACKEND_TYPE => 'Other::Dummy',
    ...
    my $requestingCircuit = createRequestingCircuit($time, 'Other::Dummy', 'T2_ANSE_CERN_1', 'T2_ANSE_CERN_2');
    my $establishedCircuit = createEstablishedCircuit($time, '192.168.0.1', '192.168.0.2', undef, $time, 'Other::Dummy', 'T2_ANSE_CERN_2', 'T2_ANSE_CERN_1');
    my $onlineBandwidth = createRunningBandwidth($time, 'Other::Dummy', 'T2_ANSE_CERN_Dev', 'T2_ANSE_CERN_1');
    my $updatingBandiwdth = createUpdatingBandwidth($time, 'Other::Dummy', 'T2_ANSE_CERN_1', 'T2_ANSE_CERN_Dev');
...
sub testVSCUnclaimedCircuits {
    ...
    my $wrongScopeCircuit = createEstablishedCircuit($time, '192.168.0.1', '192.168.0.2', undef, $time, 'Other::Dummy', 'T2_ANSE_CERN_1', 'T2_ANSE_CERN_2');
    ...
    my $deprecatedLinksCircuit = createEstablishedCircuit($time, '192.168.0.1', '192.168.0.2', undef, $time, 'Other::Dummy', 'T2_ANSE_CERN_3', 'T2_ANSE_CERN_4');
...
sub testVSCSkipIdenticalCircuits {
    ...
    my $existingCircuit = createEstablishedCircuit($time, '192.168.0.1', '192.168.0.2', undef, $time, 'Other::Dummy', 'T2_ANSE_CERN_1', 'T2_ANSE_CERN_2');
...
sub testVSCRemoveSimilarCircuits {
    ...
    my $onDiskCircuit = createEstablishedCircuit($time, '192.168.0.1', '192.168.0.2', undef, $time, 'Other::Dummy', 'T2_ANSE_CERN_1', 'T2_ANSE_CERN_2');
    $onDiskCircuit->{STATE_DIR} = "$baseLocation".'/data/circuits';
    $onDiskCircuit->saveState();

    my $inMemoryCircuit = createEstablishedCircuit($time - 10, '192.168.0.1', '192.168.0.2', undef, $time - 10, 'Other::Dummy', 'T2_ANSE_CERN_1', 'T2_ANSE_CERN_2');
...
sub testVSCHandleCircuitRequest {
    ...
    my $request = createRequestingCircuit($time, 'Other::Dummy', 'T2_ANSE_CERN_1', 'T2_ANSE_CERN_2');
...
sub testVSCHandleEstablishedCircuits {
    ...
    my $establishedNotYetExpired = createEstablishedCircuit($time - 0.3, '192.168.0.1', '192.168.0.2', undef, $time - 0.3, 'Other::Dummy', 'T2_ANSE_CERN_2', 'T2_ANSE_CERN_Dev', 0.5);
    $establishedNotYetExpired->{STATE_DIR} = "$baseLocation".'/data/circuits';
    $establishedNotYetExpired->saveState();

    my $establishedNotExpired = createEstablishedCircuit($time - 0.3, '192.168.0.1', '192.168.0.2', undef, $time - 0.3, 'Other::Dummy', 'T2_ANSE_CERN_1', 'T2_ANSE_CERN_2', 1.0);
    $establishedNotExpired->{STATE_DIR} = "$baseLocation".'/data/circuits';
    $establishedNotExpired->saveState();

    my $establishedExpired = createEstablishedCircuit($time - 0.6, '192.168.0.1', '192.168.0.2', undef, $time - 0.6, 'Other::Dummy', 'T2_ANSE_CERN_2', 'T2_ANSE_CERN_1', 0.4);
    $establishedExpired->{STATE_DIR} = "$baseLocation".'/data/circuits';
    $establishedExpired->saveState();

    my $establishedNoExpiration = createEstablishedCircuit($time, '192.168.0.1', '192.168.0.2', undef, $time, 'Other::Dummy', 'T2_ANSE_CERN_1', 'T2_ANSE_CERN_Dev');
...
sub testRCInvalidCircuitRequests {
    ...
    $circuitManager->{RESOURCES}{'T2_ANSE_CERN_2-to-T2_ANSE_CERN_1'} = createRequestingCircuit($time, 'Other::Dummy', 'T2_ANSE_CERN_2', 'T2_ANSE_CERN_1');;
