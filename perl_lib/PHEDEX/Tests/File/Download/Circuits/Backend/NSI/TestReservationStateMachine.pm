package PHEDEX::Tests::File::Download::CircuitBackends::NSI::TestReservationStateMachine;
...
use PHEDEX::File::Download::Circuits::Backend::NSI::ReservationStateMachine;
...
sub testInitialisation {
    ...
    my $rsm = PHEDEX::File::Download::Circuits::Backend::NSI::ReservationStateMachine->new(CURRENT_STATE   => STATE_CREATED, 
...
sub testNextSteps {
    ...
    $rsm = PHEDEX::File::Download::Circuits::Backend::NSI::ReservationStateMachine->new(CURRENT_STATE   => STATE_CREATED, 
                                                                                                      TRANSITIONS     => RESERVATION_TRANSITIONS);
